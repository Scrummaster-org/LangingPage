          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              <div className="flex justify-center mb-8">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-green-400/20 to-green-600/20 border border-green-400/30 flex items-center justify-center backdrop-blur-sm">
                  {service.icon}
                </div>
              </div>
